...
<body style="margin: 0;">
  <!-- アイコン表示 -->
  <input type="button" value="Icon表示" onclick="testShowIcon();" />
  <br /><br />
  ...
  <script>
    ...
    array.forEach(elm => {
        sampleArea.innerHTML = elm['name']+'さんの出身地は'+elm['pref']+'です。<br>';
    })
    </script>
    <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAzB70xpfmp81NvE6UlsmiTxXJIFSIxiJs&callback=initMap">
      </script>
